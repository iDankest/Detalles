...
const imgData = [
  { text:'Demostrando nuestro flow',time: 110, img: 'https://lh3.googleusercontent.com/pw/AP1GczOzr7sz0kuS-uMfthFWbY7o-nz9BL52vQhFcoVkpPiSXvXnJtbBvmrO2C4MiKyNUoi7b4wvJ80Qnw7_ksxEHrOiWL6duKeO6ui_pz5_CmrO1HoIecES-F0T8_HG_MnHjU9SBkOPWnrvLNJkeVO7cwvN=w986-h1315-s-no?authuser=0' },
  ...
  { text:'La cabra que sube cualquier montaña a su paso',time: 90, img: 'https://lh3.googleusercontent.com/pw/AP1GczPR68ndvBXtBZl95vfidYvXhN7NPXD84t-v1BXUaUpFvtEV5IB3W70ndexxvS41kXCWhIX2MoSn75KmbzqDOjdm2qpje07twGRCyLQV-HPSYnwNjEJ8dmoHGdZLIDMSS9F36BLvzDAM9s79HyF7u_7l=w992-h1323-s-no?authuser=0' },
  ...
  { text:'Siempre demostrando lo mala que eres...',time: 55, img: 'https://lh3.googleusercontent.com/pw/AP1GczNnhWlQEuGSQ2FbhOfKpL_Of13Trry8oYLkh1WbMjpN1XYjzWKfpjJAL8SuxohoDQlywnfsKSHf2c74P8VPV4OC2UbxLbmUWYaA4rcfujjg6-Fc1Aj62K8LhlH4xrRbrHJ2gKpATRDf6sI__1HxY28K=w992-h1323-s-no?authuser=0' },
  ...
  { text:'¿No hay algo raro?',time: 95, img: 'https://lh3.googleusercontent.com/pw/AP1GczOXx05Lb-kRIxQiCLHh97IdrfVE2TN4zyqrmFLIDCFAb0PiJCLOgHc7p0_L6PcWSUnFc5dAf8hMYFrxPdzY36xmBmvEqmLGMisrWDDoahZblh5J1aLdSt7c9E7TDYjTZgrjdA47Q_-TXljOsHoEV2vP=w992-h1323-s-no?authuser=0' },
  ...
  { text:'Ella sacando fotos a un súper modelo',time: 120, img: 'https://lh3.googleusercontent.com/pw/AP1GczOqQqCtPA5MfYsB3usReYJinvJ5frAbvPLYknie42ntvcpg6UQVNC05WhHGbMUkd2tQ8mvgsVPvKdgge_MRQfv2kygAsGmliVWSNmcEiirehzg1kCRU9QFUe9BlqZ9Xrt7KftNh9-zMYAD1Nt-lokLR=w992-h1323-s-no?authuser=0' },
...
//setInterval(updateLyrics, 1000);
   ...
   const updateContent = () => {
    ...
    if (currentData) {
      ...
      let fadeInDuration = 0.2;  // Duración de la animación de opacidad
